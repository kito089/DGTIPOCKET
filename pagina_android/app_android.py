...
def boleta():
    ...
    ruta_docx = os.path.expanduser('~/DGTIPOCKET/pagina_android/static/boletas/{0}.docx'.format(nombr[3][0]+"_"+nombr[3][1]))
    word2pdf(ruta_docx)
    ruta_pdf = os.path.expanduser('~/DGTIPOCKET/pagina_android/static/boletas/{0}.pdf'.format(nombr[3][0]+"_"+nombr[3][1]))

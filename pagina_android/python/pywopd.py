...
def convHA(tc,e,con):
    ...
    if int(control[1]) > 1:
        avances.extend(["44",str(((acredi+noacredi)*100)/44),"404","12","416",str(int((cred*100)/404)),0,"44",str(round(int((cred*100)/416),1))])
    else:
        avances.extend(["31",str(((acredi+noacredi)*100)/31),"340","20","360",str(int((cred*100)/340)),0,"31",str(round(int((cred*100)/360),1))])
